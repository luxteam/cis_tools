...
def main():
	...
	get_json = requests.get("https://render.cis.luxoft.com/job/{jenkins_job}/{build_number}/api/json?pretty=true".format(jenkins_job=args.jenkins_job, build_number=args.build_number), \
	...
	for job in job_json['artifacts']:
		artifacts[job['fileName']] = "https://render.cis.luxoft.com/job/{jenkins_job}/{build_number}/artifact/Output/{art}"\
