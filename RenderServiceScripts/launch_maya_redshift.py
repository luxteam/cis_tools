...
def main():
	...
	cmd_render = '''set MAYA_SCRIPT_PATH=%CD%;MAYA_SCRIPT_PATH; \n"C:\\Program Files\\Autodesk\\Maya{tool}\\bin\\Render.exe" -r redshift -preRender "source render.mel" -proj "{project}" -log redshift_tool.txt -of jpg -rd {output_path} {redshift_scene}'''\
